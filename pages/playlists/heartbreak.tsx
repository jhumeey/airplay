...
const HeartbreakPlaylists = ({ playlists, genre }: PlaylistProps) => {
  return (
    <>
...
export default HeartbreakPlaylists;

HeartbreakPlaylists.getLayout = function getLayout(page: React.ReactElement) {
  return <Layout>{page}</Layout>;
};

export const getStaticProps: GetStaticProps = async () => {
  const filter = 'heartbreak'
